package net.droidplays08.droid_create_ss_crate;
...
@Mod(Droid_Create_SS_Crate.MOD_ID)
public class Droid_Create_SS_Crate
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "droid_create_ss_crate";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();

    public Droid_Create_SS_Crate()
    {
